...
func NewRouter() *mux.Router {
	...
	router.HandleFunc("/routes", HandleRequest(options)).Methods("OPTIONS")
	...
	router.HandleFunc("/routes/{id}", HandleRequest(options)).Methods("OPTIONS")
	...
	router.HandleFunc("/controllers/{cid}/routes", HandleRequest(options)).Methods("OPTIONS")
	router.HandleFunc("/controllers/{cid}/routes/{rid}", HandleRequest(controllerCtrl.UnlinkRoute)).Methods("DELETE")
	router.HandleFunc("/controllers/{cid}/routes/{rid}", HandleRequest(options)).Methods("OPTIONS")
	...
	router.HandleFunc("/variables", HandleRequest(options)).Methods("OPTIONS")
	...
	router.HandleFunc("/variables/{id}", HandleRequest(options)).Methods("OPTIONS")
	...
	router.HandleFunc("/routes/{rid}/variables", HandleRequest(options)).Methods("OPTIONS")
	router.HandleFunc("/routes/{rid}/variables/{vid}", HandleRequest(routeCtrl.UnlinkVariable)).Methods("DELETE")
	router.HandleFunc("/routes/{rid}/variables/{vid}", HandleRequest(options)).Methods("OPTIONS")
